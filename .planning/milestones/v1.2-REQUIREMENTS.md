# Requirements Archive: v1.2 Library & Patterns Overhaul
...
- [x] **PATN-02**: New behavioral summary pattern category generated from takeaway data showing what companies did wrong and common behavioral patterns
